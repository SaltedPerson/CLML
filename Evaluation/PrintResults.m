...
function PrintResults(Result)
    ...
    if n == 2
        ...
        fprintf('------------------------------------\n');
        fprintf('HammingLoss           %.3f  %.4f\r',Result(1,1),Result(1,2));
        fprintf('ExampleBasedAccuracy  %.4f  %.4f\r',Result(2,1),Result(2,2));
        fprintf('ExampleBasedPrecision %.4f  %.4f\r',Result(3,1),Result(3,2));
        fprintf('ExampleBasedRecall    %.4f  %.3f\r',Result(4,1),Result(4,2));
        fprintf('ExampleBasedFmeasure  %.4f  %.4f\r',Result(5,1),Result(5,2));

        fprintf('SubsetAccuracy        %.4f  %.3f\r',Result(6,1),Result(6,2));
        fprintf('LabelBasedAccuracy    %.4f  %.3f\r',Result(7,1),Result(7,2));
        fprintf('LabelBasedPrecision   %.4f  %.3f\r',Result(8,1),Result(8,2));
        fprintf('LabelBasedRecall      %.4f  %.3f\r',Result(9,1),Result(9,2));
